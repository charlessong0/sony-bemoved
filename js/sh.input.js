...
!function (SH) {
    !function (Input) {
        ...
        var EventTypes = Input.EventTypes, mousewheelTarget = $(window).add($('#sonynav')[0].contentWindow).add('html,body');
        ...
        }(), touchTarget = $('#full-content').add($('#sonynav')[0].contentWindow).add(window).add('html,body'), TouchHandler = function () {
