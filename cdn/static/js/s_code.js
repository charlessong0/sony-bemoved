...
s.dynamicAccountList="sonycorpdev=test.sony.com;dvstest.snycms.sonynei.com;sonycorpstage=stage.sony.com;dvstage.snycms.sonynei.com;sonycorpsonywonder=www.sonywondertechlab.com;sonycorpdev02=lvn-sny-dvcms02.sonynei.net;sonycorpintranet=intranet.sca.sony.com"
...
function s_doPlugins(s) {
    ...
    s.prop41 = s.eVar41 = s.getDaysSinceLastVisit('s_getDaysSinceLastVisit');
    s.prop42 = s.eVar42 = s.getNewRepeat(30,'s_getNewRepeat');
    s.prop43 = s.eVar43 = s.getVisitNum();
    var tp = s.getTimeParting('n','-5');
    s.prop44 = s.eVar44 = tp;

    if (rwdPage) {
        s.prop45 = s.eVar45 = s.getRwd(true,768,1000);
    }
    else {
        s.prop45 = s.eVar45 = s.getRwd(false,768,1000);
    }
    ...
    */
    ...
    // New error tracking per #4709
    errorCheck = $( "title" ).html();
    if (errorCheck === "SONY USA - Page Not Found") {
    s.pageName = "";
